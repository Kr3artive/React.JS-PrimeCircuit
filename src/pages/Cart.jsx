...
const Cart = () => {
  ...
  return (
    <div onClick={() => setTogglesearch(false)}>
      <strong className=" flex justify-center mt-4 text-4xl">
        SHOPPING CART
      </strong>
      {cart.length > 0 ? (
        <div className="p-2">
          <div>
            ...
            <div className="flex flex-col mt-4 mb-4 justify-around md:flex-row lg:flex-row xl:flex-row">
              <Link className="bg-green-500 p-2 text-center" to="/Shop">
                Continue Shopping
              </Link>
              <Link className="text-black font-bold" to="/CheckOut">
                CHECK-OUT
              </Link>
            </div>
          </div>
        ...
        <div className="grid text-2xl mt-4 mb-4 justify-center">
          ...
          <Link
            className="bg-black text-white text-lg text-center mt-2 rounded-md p-2"
            to="/Shop"
          >
            Shop Now
          </Link>
