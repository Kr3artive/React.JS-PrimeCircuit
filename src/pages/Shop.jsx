    ...
    <section onClick={()=>setTogglesearch(false)}>
      {isLoading ? (
          <div className='flex items-center justify-center min-h-screen'>
            <button className='bg-black text-white text-[40px] font-semibold py-2 px-4 rounded flex items-center' disabled>
              <RiProgress3Line className='animate-spin h-5 mr-3'/>
            </button>
          </div>
      ):(<>
        <div className='grid p-10 justify-center'>
        <strong className='text-4xl bg-black text-white rounded-md p-1 mt-4 mb-4 text-center'>MEN'S CATEGORY</strong>
        ...
        <div className='grid p-10 justify-center'>
        <strong className='text-4xl bg-black text-white rounded-md p-1 mt-4 mb-4 text-center'>WOMEN'S CATEGORY</strong>
        ...
        <div className='grid p-10 justify-center'>
        <strong className='text-4xl  bg-black text-white rounded-md p-1 mt-4 mb-4 text-center'>ELECTRONICS</strong>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2'>
        ...
        <div className='grid p-10 justify-center'>
        <strong className='text-4xl bg-black text-white rounded-md p-1 mt-4 mb-4 text-center'>JEWELERIES</strong>
